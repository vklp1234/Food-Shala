            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">All Order List</h4>
                    </div>
                                           ...
                                           for ($i=0; $i < count($result['orders_list']) ; $i++) { 
                                            ...
                                            <tr>
                                                ...
                                                <td>₹<?php echo $result['items_list'][$i][0]['item_price'];?>/-</td>
                                                 ...
                                                 <td><button class="btn btn-success btn-sm completion" data-item_id="<?php echo $result['orders_list'][$i]['item_id'];?>" data-cont_no="<?php echo $result['orders_list'][$i]['contact_no'];?>" data-resto_id="<?php echo $restaurant_id;?>">done</button></td>
            ...
            $.ajax({
                ...
                success:function(response){
                    if (response==true) 
                    {
                        ...
                        setTimeout(function(){window.location="<?php echo base_url('main/restaurant_orders');?>"},1000);
                    }else{
                        alert('having some problems...!');
                    }
                }
            });
        });
