...
<head>
    ...
    <title> Foodshala | List Of Food Items</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12">
                            ...
                            <div class="white-box">
                            <h3 class="box-title">Added Items List</h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody id="list_of_items">
                                        ...
                                        if ($result['status']=='empty') {
                                            ?>
                                                <tr>
                                                    <td colspan="6">Empty no item added...</td>
                                                </tr>
                                            <?php
                                           ...
                                           for ($i=0; $i < count($result['items']) ; $i++) { 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $result['items'][$i]['item_name'];?></td>
                                                <td>₹<?php echo $result['items'][$i]['item_price'];?>/-</td>
                                                <td><?php echo $result['items'][$i]['item_quantity'];?></td>
                                                <td><?php echo $result['items'][$i]['item_description'];?></td>
