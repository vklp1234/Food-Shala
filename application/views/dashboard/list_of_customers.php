...
<head>
    ...
    <title>Foodshala | Customers</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">All Customers List</h4>
                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody id="list_of_items">
                                        ...
                                        if ($result['status']=='empty') {
                                            ?>
                                                <tr>
                                                    <td colspan="6">No customer At...!</td>
                                                </tr>
                                            <?php
                                        }elseif ($result['status']=='success') {
                                           //var_dump('<pre>',$result);
                                           for ($i=0; $i < count($result['orders_list']) ; $i++) {
                                           $filename = $result['cutomer_info'][$i][0]['image']; 
                                            ?>
                                            <tr>
                                                <td><?php echo ($i+1);?></td>
                                                <td><img  src="<?php echo base_url('uploads/').$filename;?>" class="img-thumbnail" style="width: 75px;height: 75px;" ></td>
                                                <td><?php echo $result['cutomer_info'][$i][0]['name'];?></td>
                                                <td><a href="mailto:<?php echo $result['cutomer_info'][$i][0]['email'];?>"><?php echo $result['cutomer_info'][$i][0]['email'];?></a></td>
                                                 <td><?php echo $result['cutomer_info'][$i][0]['contact_no'];?></td>
                                                  <td><?php echo $result['cutomer_info'][$i][0]['detailed_address'];?></td>
