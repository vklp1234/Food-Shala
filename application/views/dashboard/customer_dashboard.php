...
<head>
    ...
    <title>Foodshala | Dashboard</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success"><?php echo $result['no_of_order'][0]['no_of_order'];?></span></li>
                            </ul>
                        </div>
                    </div>
                    <!-- <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Restaurants From Orders</h3>
                            <ul class="list-inline two-part">
                                <li>
